        ...
        die(
            '<div class="container mt-5">
                <div class="alert alert-danger">
                    ...
                    <p class="mb-0">' . html_escape($e->getMessage()) . '</p>
                </div>
            </div>'
        );
    }
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if ($logged_in): ?>
                        <?php if (is_administrator()): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="view_quotes.php">
                                    <i class="bi bi-card-list me-1"></i>
                                    Trích dẫn
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="add_quote.php">
        ...
        <div class="card border-0 shadow-sm mb-2">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-1" style="width: 30px; height: 30px;">
