                ...
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="mb-0 opacity-75">
                            Tìm kiếm trích dẫn theo từ khóa
                            hoặc tác giả
                        </p>
                    </div>
                </div>
                ...
                >
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            >
                                <option value="">
                                    Tất cả nguồn / tác giả
                                </option>
                                <?php foreach ($sources as $source): ?>
                                    <option
                                        value="<?= html_escape($source) ?>"
                                        <?php if (
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <?php if (is_administrator()): ?>
                                            ...
                                            >
                                                ...
                                                >
                                                    <a
                                                        href="edit_quote.php?id=<?= urlencode(
                                                            $quote["id"],
                                                        ) ?>"
                                                        class="btn
                                                               btn-outline-primary
                                                    ...
                                                    <a
                                                        href="delete_quote.php?id=<?= urlencode(
                                                            $quote["id"],
                                                        ) ?>"
                                                        class="btn
                                                               btn-outline-danger
                ...
                >
                    ...
                    >
                        ...
                        <p class="text-muted mb-2">
                            Không có trích dẫn nào phù hợp
                            với điều kiện tìm kiếm của bạn.
                        </p>
                        <a
                            href="search.php"
