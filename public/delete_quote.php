        ...
        <div class="col-lg-8">
            ...
            >
                <div class="d-flex align-items-start">
                    <i
                        class="bi bi-check-circle-fill fs-5 me-1"
                    ></i>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-7">
            ...
            >
                ...
                >
                    <div
                        class="bg-white text-danger rounded-circle
                               d-inline-flex align-items-center
                               justify-content-center mb-1"
                        style="width: 30px; height: 30px;"
                    >
                        <i
                            class="bi bi-trash3-fill fs-6"
                        ></i>
                    </div>
                ...
                <div class="card-body p-2">
                    ...
                    >
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <p class="mb-0">
                                    Trích dẫn này sẽ bị xóa vĩnh viễn
                                    khỏi cơ sở dữ liệu.
                                </p>
                            </div>
                        </div>
                    ...
                    <!-- Quote -->
                    <div
                        class="card bg-light border-0 rounded-4 mb-2"
                    >
                        <div class="card-body p-4">
                            ...
                            <blockquote
                                class="blockquote text-center mb-2"
                            >
                            ...
                            <!-- Favorite -->
                            <?php if (
                                is_checked($quote_details["favorite"])
                            ): ?>
